...
# Mirror of pursue_fly_action: moves away from the nearest player in
# both axes and marks the actor as vertically-driven for this tick.
#
# params:
...
func tick(actor: Node, _blackboard: Blackboard) -> int:
    ...
    var delta: Vector2 = (actor as Node2D).global_position - best.global_position
