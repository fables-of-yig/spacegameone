...
# Drives actor's horizontal velocity leftward. Explicit direction —
# does NOT update beh_facing. Use turn_around + walk if you want
# directional patrols; use this when the author always wants left.
#
# params:
