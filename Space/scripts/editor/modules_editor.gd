...
const LegacyDataEditor = preload("res://Space/scripts/editor/data_editor.gd")
...
func _build_ui() -> void:
    ...
    var note := Label.new()
    note.text = "Shared ship-module data used by the builder, loot tables, and shop stock."
    ...
    _legacy = Control.new()
    _legacy.set_script(LegacyDataEditor)
    _legacy.editor_mode = "modules"
